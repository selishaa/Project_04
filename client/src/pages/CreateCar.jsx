...
const CreateCar = () => {
  ...
  const handleRoofOptionClick = (optionName, optionPrice) => {
    let temp;
    if (interior === "Black Premium Interior" && optionName === "Panoramic Glass Roof") {
      alert("You cannot select 'Black Premium Interior' and 'Panoramic Glass Roof' together.");
